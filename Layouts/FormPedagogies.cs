...
{
    public partial class FormPedagogies : Form
    {
        ...
        /// </summary>
        private async void FormPedagogies_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        public void BtnAdministration_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Cacher FormPedagogies avant d'ouvrir FormAdmins
                this.Hide();
                ...
                // Réafficher FormPedagogies après la fermeture de FormAdmins
                this.Show();
            }
            catch (Exception ex)
            {
                MessageBox.Show($"Erreur lors de l'ouverture du module d'administration: {ex.Message}",
                    "Erreur", MessageBoxButtons.OK, MessageBoxIcon.Error);
                // S'assurer que FormPedagogies est visible en cas d'erreur
                this.Show();
            }
        }
        ...
        public void BtnFinance_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                // Cacher FormPedagogies avant d'ouvrir FormFinances
                this.Hide();
                ...
                // Réafficher FormPedagogies après la fermeture
                this.Show();
            }
            catch (Exception ex)
            {
